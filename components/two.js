...
export default function Two({ title, children }) {
  return (
    <>
      <Head>
      ...
      <Container>
        <div className="flex flex-col-reverse flex-wrap pb-12 lg:grid lg:grid-cols-3 lg:gap-16">
          <main className="mt-6 lg:col-span-2 md:mt-12">{children}</main>

          <aside className="relative max-w-md py-8">
            <div className="sticky top-0 pt-4">
              <div className="px-6 pt-4 pb-6 text-gray-800 bg-gray-100 rounded">
                <div>
                  <div class="flex items-center">
                    <svg
                      class="text-gray-400 fill-current w-4 h-4"
                      viewBox="0 0 24 24"
                      fill="none"
                    ...
                    <span class="ml-2 text-xl font-bold">Name</span>
                  </div>
                ...
                <div class="flex items-center mt-3">
                  ...
                  <span class="ml-2">email@test.com</span>
                </div>
              </div>
            </div>
          </aside>
